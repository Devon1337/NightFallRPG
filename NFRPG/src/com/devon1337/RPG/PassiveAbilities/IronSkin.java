...
public class IronSkin extends Passive implements IPassive {
	...
	public void start(NFPlayer player) {
		player.getPlayer().setAbsorptionAmount(absorbtionAmount);
	}

	@Override
	public void stop(NFPlayer player) {
		player.getPlayer().setAbsorptionAmount(0);
	}
