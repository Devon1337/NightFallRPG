...
public class Assassinate extends Spell implements ISpell, Update {
	...
	static final String Name = "Assassinate",
			Description = "When a player is below 30% HP it will instantly kill the target!";
