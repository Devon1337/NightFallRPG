...
import com.devon1337.RPG.Quests.Exceptions.QuestIDInUse;
 ...
 public abstract class Quest
 {
   ...
   public int CurSteps = 0; public int StepAmount = 5;
   public String Title;
   ...
   public String Code; public String[] Steps;
   ...
   public void setStatus(int Status) {
    if (Status == 2) {
       getPlayer().sendMessage(ChatColor.LIGHT_PURPLE + "Quest Complete: " + ChatColor.GOLD + ChatColor.BOLD + this.Title);
